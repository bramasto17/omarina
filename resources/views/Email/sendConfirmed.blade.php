		...
		<div class="container">
			...
			<div class="row setup-content">
				<div class="col-md-10 col-sm-10 col-xs-10 col-md-offset-1 col-sm-offset-1 col-xs-offset-1">
					<h3>Pesanan anda dengan nomor @{{vm.TransactionID}} sedang dikerjakan</h3>
					<p>Dear <b>Bramasto Wibisono</b>,</p>
					<p>
						Pembayaran anda sebesar <b>Rp. @{{vm.GrandTotal}}</b> telah kami terima dan pesanan anda sedang kami kerjakan.

						<br><br>
						Bila pesanan telah kami kirim, kami akan mengirimi anda email berisi nomor resi pengiriman pesanan anda.
					</p>
