		...
		<div class="container">
			...
			<div class="row setup-content">
				<div class="col-md-10 col-sm-10 col-xs-10 col-md-offset-1 col-sm-offset-1 col-xs-offset-1">
					<h3>Pesanan anda dengan nomor @{{vm.TransactionID}} telah dikirim</h3>
					<p>Dear <b>Bramasto Wibisono</b>,</p>
					<p>
						Kami telah mengirim pesanan anda melalui JNE dengan nomor resi ...
						<br><br>
						Anda dapat mengecek paket kiriman anda di <a href="http://jne.co.id"> jne.co.id</a>
					</p>
